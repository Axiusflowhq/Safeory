...
- Added a machine-checkable qualified-review record workflow. Generated provenance
  ...
  other than the sign-off record/`PLAN.md` closure, unrelated staged/unstaged/
  untracked worktree paths, altered artifact files, blocking conclusions, or
...
- Added a tracked cross-language carrier fixture generated by the adapted pinned
  SDK itself. It contains the actual opaque blob `data` plus wrapped cipher `key`
  for the representative insurance `SafeoryEnvelopeV1`; the Rust harness decrypts
