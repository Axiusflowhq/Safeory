...
try {
  const compiled = run(node, [
    ...
    "src/sync-device-enrollment.ts",
    "src/sync-error.ts",
    "src/sync-queue.ts",
    "src/sync-pull.ts",
    "src/sync-domain.ts",
    "src/sync-account-bootstrap.ts",
    ...
    "tests/sync-device-enrollment.test.ts",
    "tests/sync-queue.test.ts",
    "tests/sync-pull.test.ts",
    "tests/sync-domain.test.ts",
    "tests/sync-account-bootstrap.test.ts",
