...
| Stolen remote root-wrap material | Password-only offline guessing | Before cloud launch add a reviewed high-entropy Account Secret or equivalent enrollment factor; keep recovery independent | Loss of every authorized device and recovery factor can make data unrecoverable |
