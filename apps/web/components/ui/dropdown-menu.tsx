...
function DropdownMenuSubTrigger({
  ...
  return (
    <MenuPrimitive.SubmenuTrigger
      ...
      data-inset={inset}
      className={cn(
        "flex cursor-default items-center gap-1.5 rounded-[var(--radius-small)] px-1.5 py-1 text-sm outline-hidden select-none focus:bg-[var(--active-bg)] focus:text-[var(--text-primary)] not-data-[variant=destructive]:focus:**:text-[var(--text-primary)] data-inset:pl-7 data-popup-open:bg-[var(--active-bg)] data-popup-open:text-[var(--text-primary)] data-[open]:bg-[var(--active-bg)] data-[open]:text-[var(--text-primary)] [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    >
...
function DropdownMenuCheckboxItem({
  ...
  return (
    <MenuPrimitive.CheckboxItem
      ...
      data-inset={inset}
      className={cn(
        "relative flex cursor-default items-center gap-1.5 rounded-[var(--radius-small)] py-1 pr-8 pl-1.5 text-sm outline-hidden select-none focus:bg-[var(--active-bg)] focus:text-[var(--text-primary)] focus:**:text-[var(--text-primary)] data-inset:pl-7 data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      checked={checked}
      {...props}
